     ...
     useEffect(() => {
       const fetchCurrentClaim = async () => {
         try {
           ...
           setClaimStatus(update.claimStatus);
           setClaimAmount(update.claimAmount);
           setDescription(update.description);
           setSelectedPolicy(update.policy.id);
         } catch (error) {
           console.error(error);
         }
       };
       ...
       const handleSubmit = async (e) => {
         ...
         ClaimService.updateCurrentClaim(currentClaim, id)
           .then(() => {
             navigate("/claims");
              ...
              >
                {policies.map((policy) => (
                  <option key={policy.id} value={policy.id}>
                    {policy.policyNumber} - {policy.policyFirstName}{" "}
                    {policy.policyLastName}
                  </option>
                ))}
              </select>
            </div>
