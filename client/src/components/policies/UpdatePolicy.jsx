...
const UpdatePolicy = () => {
   ...
   useEffect(() => {
     const fetchCurrentPolicy = async () => {
       try {
         ...
         const parsedStartDate = moment(update.startDate, "MM-DD-YYYY");
         const parsedEndDate = moment(update.startDate, "MM-DD-YYYY");

         setPolicyNumber(update.policyNumber);
         setPolicyType(update.policyType);
         setCoverageAmount(update.coverageAmount);
         setPremium(update.premium);
         setStartDate(parsedStartDate);
         setEndDate(parsedEndDate);
         setSelectedClient(update.client.id);
       } catch (error) {
         console.error(error);
       }
     };
   ...
   const handleSubmit = async (e) => {
     ...
     PolicyService.updatePolicy(id, currentPolicy)
       .then(() => {
         navigate("/policies");
